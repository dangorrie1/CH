...
routelistbegin = temp_route_list[perm_route_counter]
routelistend = temp_route_list[perm_route_counter + 1]
...
link_list.append(destination_list[perm_route_counter])
...
decimal = fractionlist[perm_route_counter] / fraction_sum
